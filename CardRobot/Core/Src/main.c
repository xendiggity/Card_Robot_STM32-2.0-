...
// Opens solenoid 1 long enough to allow a card in/out
void solenoid_1_open() {
	HAL_Delay(5);
...
// Opens solenoid 2 long enough to allow a card in/out
void solenoid_2_open() {
	HAL_Delay(5);
...
// Opens solenoid 3 long enough to allow a card in/out
void solenoid_3_open() {
	HAL_Delay(5);
